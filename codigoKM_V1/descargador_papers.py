...
historic_file.write(main_search2+' LISTA DE PAPERS:'+'\t'+'STATUS'+'\n')
for i, k in enumerate(nombres_list):
    historic_file.write(k+'\t'+flag_descargado[i]+'\n')

historic_file.write('FIN DE BUSQUEDA '+main_search2+'\t'+str(num)+' PAPERS DESCARGADOS'+'\r\n')
historic_file.close()
